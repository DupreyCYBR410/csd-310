...
Description: Program for updating and deleting players in database
"""
...
try:
    ...
    player_data = ("Peeves", "Poltergeist", 1)
    ...
    update_player = ("UPDATE player SET team_id = 2, first_name = 'Chaos', last_name = 'Spirit' WHERE first_name = 'Peeves'")

    cursor.execute(update_player)

    show_players(cursor, "DISPLAYING PLAYERS AFTER UPDATE")

    delete_player = ("DELETE FROM player WHERE first_name = 'Chaos'")
